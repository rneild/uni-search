...
<p class="summary">{{ total_unis }} universities tracked · <a href="{{ '/profile/' | relative_url }}">View profile</a> · <a href="{{ '/criteria/' | relative_url }}">Scoring criteria</a> · <a href="{{ '/insights/' | relative_url }}">Insights</a> · <a href="{{ '/log/' | relative_url }}">Session log</a></p>
